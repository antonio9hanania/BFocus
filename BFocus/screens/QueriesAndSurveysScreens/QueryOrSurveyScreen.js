...
import { Alert, Button, AsyncStorage, ImageBackground, ScrollView, Picker, TouchableOpacity, View, StyleSheet } from 'react-native';
...
export default class QueryOrSurveyScreen extends Component {
    ...
    publishQueryOrSurvey() {
        ...
        console.log("groupPositionIndex: " + this.state.groupPositionIndex);
                ...
                this.uploadToServer(SERVER_ADDR + "PublishQueryOrSurvey", (status, responseJson) => {
                    ...
                    if (status === 200) {
                        ...
                        this.setState({
                            ...
                            groupPositionIndex: this.state.groupPositionIndex + 1
                        });
                    }
                });
            });
